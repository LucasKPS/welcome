...
import { View, Text, StyleSheet, Appearance, Platform, ScrollView, SafeAreaView, FlatList, Image, Pressable } from 'react-native';
            ...
            <>
              <Pressable
                ...
                onPress={() => router.push({
                  ...
                  params: { id: item.id.toString(), title: item.title, description: item.description }
                })}
              >
              ...
              {item.id < MENU_ITEMS.length && <View style={styles.menuProductDivider} />}
            </>
          );
        }}
